...
void CG_RailTrail2( clientInfo_t *ci, vec3_t start, vec3_t end ) {
	...
	Com_ParseHexColor( le->color, cg_railTrailColor.string, qtrue );
...
#define WP_DRAW_X       cgs.virtualWidth - WP_ICON_X - 4 // 4 is 'selected' border width
#define WP_DRAW_X_WIDE  cgs.virtualWidth - WP_ICON_X_WIDE - 4
#define WP_DRAW_Y       4
