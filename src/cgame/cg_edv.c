...
extern void CG_Trace( trace_t *result, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, int skipNumber, int mask );   // cg_predict.c
...
// 	CG_DrawLine(origin, cg.snap->ps.origin, ADDLINE_WIDTH, colorGreen, cgs.media.railCoreShader);
// }
